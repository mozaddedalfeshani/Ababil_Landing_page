      ...
      <header className="absolute top-0 left-0 right-0 z-10 flex justify-between items-center p-6">
        ...
        <div className="flex items-center gap-4">
          <nav className="flex items-center gap-4">
            <Link
              href="/projects"
              className="text-[#c9d1d9] hover:text-[#58a6ff] transition-colors p-2 rounded-lg hover:bg-[#21262d]"
              title="Projects">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
          <div className="space-y-4">
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight">
              <span className="bg-gradient-to-r from-[#58a6ff] to-[#79c0ff] bg-clip-text text-transparent">
                Ababil{" "}
              </span>
              <span className="text-[#dc2626]">X</span>
            </h1>
